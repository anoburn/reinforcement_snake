...
class QLearning(object):
    ...
    def initialize_NN(self,neuronCounts, activation_functions):
        self.Network = NN.NN(neuronCounts, activation_functions)
...
a.initialize_NN(np.array([6,15,15,4]),['sigmoid','sigmoid','sigmoid','sigmoid'])
